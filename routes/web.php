...
Route::get('/callback/{response}/{order_id}', [\App\Http\Controllers\HomeController::class, 'callback'])->name('callback');
...
Route::post('/review', [App\Http\Controllers\ReviewController::class, 'storeReview'])->name('storeReview');
Route::put('/review/{review}', [App\Http\Controllers\ReviewController::class, 'updateReview'])->name('updateReview');
Route::delete('/review/{review}', [App\Http\Controllers\ReviewController::class, 'deleteReview'])->name('deleteReview');
